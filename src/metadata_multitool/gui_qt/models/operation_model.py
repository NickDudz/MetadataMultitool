...
class OperationModel(QObject):
    ...
    def update_progress(self, current: int, total: int, current_file: str = "", message: str = "") -> None:
    ...
    def complete_operation(self, result: OperationResult) -> None:
        ...
        self._state = OperationState.COMPLETED if result.success else OperationState.ERROR
        self._result = result
