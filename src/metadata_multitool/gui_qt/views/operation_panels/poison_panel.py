...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QCheckBox, QGroupBox, QComboBox, QFileDialog,
    QTextEdit
)
...
class PoisonPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        formats = [("XMP Sidecar", "xmp"), ("IPTC", "iptc"), ("EXIF", "exif"), 
                  ("Sidecar", "sidecar"), ("JSON", "json"), ("HTML", "html")]
    ...
    def _load_settings(self) -> None:
        ...
        preset = self.config_model.get_operation_default("poison", "preset", "label_flip")
        true_hint = self.config_model.get_operation_default("poison", "true_hint", "")
        output_formats = self.config_model.get_operation_default("poison", "output_formats", {
    ...
    def _save_settings(self) -> None:
        ...
        self.config_model.set_operation_default("poison", "preset", self.preset_combo.currentText())
        self.config_model.set_operation_default("poison", "true_hint", self.true_hint_edit.text())
        self.config_model.set_operation_default("poison", "output_formats", output_formats)
