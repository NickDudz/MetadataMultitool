...
class CleanPanel(QWidget):
    ...
    def _load_settings(self) -> None:
        ...
        output_folder = self.config_model.get_operation_default("clean", "output_folder", "safe_upload")
        preserve_structure = self.config_model.get_operation_default("clean", "preserve_structure", True)
    ...
    def _save_settings(self) -> None:
        ...
        self.config_model.set_operation_default("clean", "output_folder", self.output_folder_edit.text())
        self.config_model.set_operation_default("clean", "preserve_structure", self.preserve_structure_check.isChecked())
