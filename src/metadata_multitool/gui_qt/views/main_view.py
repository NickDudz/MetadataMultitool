...
class MainView(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.clean_panel = CleanPanel(self.file_model, self.config_model, self.icon_manager)
        self.poison_panel = PoisonPanel(self.file_model, self.config_model, self.icon_manager)  
        self.revert_panel = RevertPanel(self.file_model, self.config_model, self.icon_manager)
        
        # Add tabs
        self.tab_widget.addTab(self.clean_panel, self.icon_manager.get_icon("clean"), "Clean")
        self.tab_widget.addTab(self.poison_panel, self.icon_manager.get_icon("poison"), "Poison")
        self.tab_widget.addTab(self.revert_panel, self.icon_manager.get_icon("revert"), "Revert")
