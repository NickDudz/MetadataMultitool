...
class FilePanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # Modified column
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # Extension column
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # Has metadata column
