...
class ProgressView:
    ...
    def setup(
        self, parent: tk.Widget, row: int = 0, column: int = 0, columnspan: int = 1
    ) -> None:
        ...
        # Progress bar
        self.progress_bar = ttk.Progressbar(self.frame, mode="determinate", length=400)
        ...
        self.cancel_button = ttk.Button(
            self.frame, text="Cancel", command=self._cancel_operation, state="disabled"
        )
