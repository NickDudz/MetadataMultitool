...
class MainWindow:
    ...
    def _setup_views(self):
        ...
        self.views = {
            "clean": CleanView(self.root, self.file_model, self.config_model, self.operation_model),
            "poison": PoisonView(self.root, self.file_model, self.config_model, self.operation_model),
            "revert": RevertView(self.root, self.file_model, self.config_model, self.operation_model),
    ...
    def _setup_title_bar(self, parent):
        ...
        # Title
        title_label = ttk.Label(title_frame, text="Metadata Multitool", font=("Arial", 16, "bold"))
        ...
        settings_btn = ttk.Button(menu_frame, text="Settings", command=self._show_settings)
    ...
    def _setup_clean_tab(self):
        ...
        browse_files_btn = ttk.Button(file_controls, text="Browse Files", command=self._browse_files)
        browse_files_btn.grid(row=0, column=0, padx=(0, 10))
        
        browse_folder_btn = ttk.Button(file_controls, text="Browse Folder", command=self._browse_folder)
        browse_folder_btn.grid(row=0, column=1, padx=(0, 10))
        
        clear_btn = ttk.Button(file_controls, text="Clear All", command=self._clear_files)
        ...
        # Clean options
        clean_options_frame = ttk.LabelFrame(tab_frame, text="Clean Options", padding="10")
    ...
    def _setup_poison_tab(self):
        ...
        # Poison options
        poison_options_frame = ttk.LabelFrame(tab_frame, text="Poison Options", padding="10")
    ...
    def _setup_revert_tab(self):
        ...
        # Revert options
        revert_options_frame = ttk.LabelFrame(tab_frame, text="Revert Options", padding="10")
